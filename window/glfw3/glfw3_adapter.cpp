...
const std::unordered_map<unsigned int, Window::OpenGLProfile>             Window::GLFW3Adapter::EnumMaps::GlProfileEnums       = Window::GLFW3Adapter::EnumMaps::getGlProfileEnums();
const std::unordered_map<unsigned int, Window::Input::Mode::Target>       Window::GLFW3Adapter::EnumMaps::InputModeTargetEnums = Window::GLFW3Adapter::EnumMaps::getInputModeTargetEnums();
const std::unordered_map<unsigned int, Window::Input::Mode::Value>        Window::GLFW3Adapter::EnumMaps::InputModeValueEnums  = Window::GLFW3Adapter::EnumMaps::getInputModeValueEnums();
const std::unordered_map<unsigned int, Window::Input::Action>             Window::GLFW3Adapter::EnumMaps::ActionEnums          = Window::GLFW3Adapter::EnumMaps::getActionEnums();
const std::unordered_map<unsigned int, Window::Input::Key>                Window::GLFW3Adapter::EnumMaps::KeyEnums             = Window::GLFW3Adapter::EnumMaps::getKeyEnums();
const std::unordered_map<unsigned int, Window::Input::Modifier>           Window::GLFW3Adapter::EnumMaps::KeyModifierEnums     = Window::GLFW3Adapter::EnumMaps::getKeyModifierEnums();
const std::unordered_map<unsigned int, Window::Input::MouseButton>        Window::GLFW3Adapter::EnumMaps::MouseButtonEnums     = Window::GLFW3Adapter::EnumMaps::getMouseButtonEnums();
const std::unordered_map<unsigned int, Window::Input::Joystick>           Window::GLFW3Adapter::EnumMaps::JoystickEnums        = Window::GLFW3Adapter::EnumMaps::getJoystickEnums();
const std::unordered_map<unsigned int, Window::Input::Gamepad::Button>    Window::GLFW3Adapter::EnumMaps::GamepadButtonEnums   = Window::GLFW3Adapter::EnumMaps::getGamepadButtonEnums();
const std::unordered_map<unsigned int, Window::Input::Gamepad::Axis>      Window::GLFW3Adapter::EnumMaps::GamepadAxisEnums     = Window::GLFW3Adapter::EnumMaps::getGamepadAxisEnums();

const std::unordered_map<Window::OpenGLProfile, unsigned int>             Window::GLFW3Adapter::ValueMaps::GlProfileValues       = Window::GLFW3Adapter::ValueMaps::getGlProfileValues();
const std::unordered_map<Window::Input::Mode::Target, unsigned int>       Window::GLFW3Adapter::ValueMaps::InputModeTargetValues = Window::GLFW3Adapter::ValueMaps::getInputModeTargetValues();
const std::unordered_map<Window::Input::Mode::Value, unsigned int>        Window::GLFW3Adapter::ValueMaps::InputModeValueValues  = Window::GLFW3Adapter::ValueMaps::getInputModeValueValues();
const std::unordered_map<Window::Input::Action, unsigned int>             Window::GLFW3Adapter::ValueMaps::ActionValues          = Window::GLFW3Adapter::ValueMaps::getActionValues();
const std::unordered_map<Window::Input::Key, unsigned int>                Window::GLFW3Adapter::ValueMaps::KeyValues             = Window::GLFW3Adapter::ValueMaps::getKeyValues();
const std::unordered_map<Window::Input::Modifier, unsigned int>           Window::GLFW3Adapter::ValueMaps::KeyModifierValues     = Window::GLFW3Adapter::ValueMaps::getKeyModifierValues();
const std::unordered_map<Window::Input::MouseButton, unsigned int>        Window::GLFW3Adapter::ValueMaps::MouseButtonValues     = Window::GLFW3Adapter::ValueMaps::getMouseButtonValues();
const std::unordered_map<Window::Input::Joystick, unsigned int>           Window::GLFW3Adapter::ValueMaps::JoystickValues        = Window::GLFW3Adapter::ValueMaps::getJoystickValues();
const std::unordered_map<Window::Input::Gamepad::Button, unsigned int>    Window::GLFW3Adapter::ValueMaps::GamepadButtonValues   = Window::GLFW3Adapter::ValueMaps::getGamepadButtonValues();
const std::unordered_map<Window::Input::Gamepad::Axis, unsigned int>      Window::GLFW3Adapter::ValueMaps::GamepadAxisValues     = Window::GLFW3Adapter::ValueMaps::getGamepadAxisValues();
...
namespace GLFW3Adapter
{
    namespace EnumMaps
    {
        std::unordered_map<unsigned int, Window::OpenGLProfile> getGlProfileEnums()
        {
            static bool runOnce = false;
            if (runOnce) return GlProfileEnums;

            std::unordered_map<unsigned int, Window::OpenGLProfile> map;
        ...
        std::unordered_map<unsigned int, Window::Input::Mode::Target> getInputModeTargetEnums()
        {
            static bool runOnce = false;
            if (runOnce) return InputModeTargetEnums;

            std::unordered_map<unsigned int, Window::Input::Mode::Target> map;
        ...
        std::unordered_map<unsigned int, Window::Input::Mode::Value> getInputModeValueEnums()
        {
            static bool runOnce = false;
            if (runOnce) return InputModeValueEnums;

            std::unordered_map<unsigned int, Window::Input::Mode::Value> map;
        ...
        std::unordered_map<unsigned int, Window::Input::Action> getActionEnums()
        {
            static bool runOnce = false;
            if (runOnce) return ActionEnums;

            std::unordered_map<unsigned int, Window::Input::Action> map;
        ...
        std::unordered_map<unsigned int, Window::Input::Key> getKeyEnums()
        {
            static bool runOnce = false;
            if (runOnce) return KeyEnums;

            std::unordered_map<unsigned int, Window::Input::Key> map;
        ...
        std::unordered_map<unsigned int, Window::Input::Modifier> getKeyModifierEnums()
        {
            static bool runOnce = false;
            if (runOnce) return KeyModifierEnums;

            std::unordered_map<unsigned int, Window::Input::Modifier> map;
        ...
        std::unordered_map<unsigned int, Window::Input::MouseButton> getMouseButtonEnums()
        {
            static bool runOnce = false;
            if (runOnce) return MouseButtonEnums;

            std::unordered_map<unsigned int, Window::Input::MouseButton> map;
        ...
        std::unordered_map<unsigned int, Window::Input::Joystick> getJoystickEnums()
        {
            static bool runOnce = false;
            if (runOnce) return JoystickEnums;

            std::unordered_map<unsigned int, Window::Input::Joystick> map;
        ...
        std::unordered_map<unsigned int, Window::Input::Gamepad::Button> getGamepadButtonEnums()
        {
            static bool runOnce = false;
            if (runOnce) return GamepadButtonEnums;

            std::unordered_map<unsigned int, Window::Input::Gamepad::Button> map;
        ...
        std::unordered_map<unsigned int, Window::Input::Gamepad::Axis> getGamepadAxisEnums()
        {
            static bool runOnce = false;
            if (runOnce) return GamepadAxisEnums;

            std::unordered_map<unsigned int, Window::Input::Gamepad::Axis> map;
    ...
    namespace ValueMaps
    {
        std::unordered_map<Window::OpenGLProfile, unsigned int> getGlProfileValues()
        {
            static bool runOnce = false;
            if (runOnce) return GlProfileValues;

            std::unordered_map<Window::OpenGLProfile, unsigned int> map;
        ...
        std::unordered_map<Window::Input::Mode::Target, unsigned int> getInputModeTargetValues()
        {
            static bool runOnce = false;
            if (runOnce) return InputModeTargetValues;

            std::unordered_map<Window::Input::Mode::Target, unsigned int> map;
        ...
        std::unordered_map<Window::Input::Mode::Value, unsigned int> getInputModeValueValues()
        {
            static bool runOnce = false;
            if (runOnce) return InputModeValueValues;

            std::unordered_map<Window::Input::Mode::Value, unsigned int> map;
        ...
        std::unordered_map<Window::Input::Action, unsigned int> getActionValues()
        {
            static bool runOnce = false;
            if (runOnce) return ActionValues;

            std::unordered_map<Window::Input::Action, unsigned int> map;

            map[Window::Input::Action::Release] = GLFW_RELEASE;
            map[Window::Input::Action::Press] = GLFW_PRESS;
            map[Window::Input::Action::Repeat] = GLFW_REPEAT;
        
            runOnce = true;
            return map;
        }

        std::unordered_map<Window::Input::Key, unsigned int> getKeyValues()
        {
            static bool runOnce = false;
            if (runOnce) return KeyValues;

            std::unordered_map<Window::Input::Key, unsigned int> map;
        ...
        std::unordered_map<Window::Input::Modifier, unsigned int> getKeyModifierValues()
        {
            static bool runOnce = false;
            if (runOnce) return KeyModifierValues;

            std::unordered_map<Window::Input::Modifier, unsigned int> map;
        ...
        std::unordered_map<Window::Input::MouseButton, unsigned int> getMouseButtonValues()
        {
            static bool runOnce = false;
            if (runOnce) return MouseButtonValues;

            std::unordered_map<Window::Input::MouseButton, unsigned int> map;
        ...
        std::unordered_map<Window::Input::Joystick, unsigned int> getJoystickValues()
        {
            static bool runOnce = false;
            if (runOnce) return JoystickValues;

            std::unordered_map<Window::Input::Joystick, unsigned int> map;
        ...
        std::unordered_map<Window::Input::Gamepad::Button, unsigned int> getGamepadButtonValues()
        {
            static bool runOnce = false;
            if (runOnce) return GamepadButtonValues;

            std::unordered_map<Window::Input::Gamepad::Button, unsigned int> map;
        ...
        std::unordered_map<Window::Input::Gamepad::Axis, unsigned int> getGamepadAxisValues()
        {
            static bool runOnce = false;
            if (runOnce) return GamepadAxisValues;

            std::unordered_map<Window::Input::Gamepad::Axis, unsigned int> map;
