#ifndef RENDERBOI_TOOLBOX_INPUT_SPLITTER_HPP
#define RENDERBOI_TOOLBOX_INPUT_SPLITTER_HPP
...
public:
    ...
    /// @brief Register a new input processor Use the returned subscription ID to detach it
...
#endif//RENDERBOI_TOOLBOX_INPUT_SPLITTER_HPP